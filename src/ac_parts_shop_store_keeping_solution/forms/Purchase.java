...
public class Purchase extends javax.swing.JFrame {
    ...
    public Purchase() {
        ...
        jLabel_purcahse_bill_no.setText(Purchase_Bill_DB.return_maximum_value_of_purchase_bill_number_plus("purchase_bill_number"));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String result;
        if (jCombobox_Payment_Type.getSelectedIndex() == 0) {
            result = Purchase_Bill_DB.insert_values(new String[]{jLabel_purcahse_bill_no.getText(), "NOW()", Common_Tasks.parse_string_seperated_by_full_column(jCombobox_supplier.getSelectedItem().toString()).elementAt(0).toString(), jLabel_total.getText(), jCombobox_Payment_Type.getSelectedItem().toString(), jLabel_total.getText()}, new int[]{5}, jTable_purchase_bill);

        } else {
            result = Purchase_Bill_DB.insert_values(new String[]{jLabel_purcahse_bill_no.getText(), "NOW()", Common_Tasks.parse_string_seperated_by_full_column(jCombobox_supplier.getSelectedItem().toString()).elementAt(0).toString(), jLabel_total.getText(), jCombobox_Payment_Type.getSelectedItem().toString(), jTextField_pay_amount.getText()}, new int[]{5}, jTable_purchase_bill);
        }
