 ...
 * @author Asus-win7
 */
public class Purchase_Item_DB {

    static String Table_name = "purchase_item";
    ...
    public static String return_maximum_value_of_purchase_item_serial_number_plus(String Column) {
