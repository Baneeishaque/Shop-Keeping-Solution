 ...
 * @author Asus-win7
 */
public class Sales_Bill_Credit_DB {

    static String Table_name = "sales_bill_credit";
    ...
    public static String return_maximum_value_of_sales_bill_credit_serial_number_plus(String Column) {
